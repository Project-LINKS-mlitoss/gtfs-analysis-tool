  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>1 - 50人</se:Name>
          <se:Description>
            <se:Title>1～50人</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
        ...
        <se:Rule>
          <se:Name>51 - 100人</se:Name>
          <se:Description>
            <se:Title>51～100人</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>101 - 150人</se:Name>
          <se:Description>
            <se:Title>101～150人</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>151 - 200人</se:Name>
          <se:Description>
            <se:Title>151～200人</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          ...
          <se:Stroke>
            ...
            <se:SvgParameter name="stroke-linejoin">bevel</se:SvgParameter>
                ...
                <se:Rule>
          <se:Name>501 - 1000人</se:Name>
          <se:Description>
            <se:Title>501～1,000人</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThanOrEqualTo>
        ...
        <se:Rule>
          <se:Name>1001人以上</se:Name>
          <se:Description>
            <se:Title>1,001人以上</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
              <ogc:PropertyIsGreaterThanOrEqualTo>
              <ogc:PropertyName>集計値</ogc:PropertyName>
